...
/**
 * create_buffer - Allocate 1024 bytes for a bufer.
 * @file: The name of the file bufer is storing char for.
 *
...
/**
 * main - Copie the content of  file to another file.
 * @argc: The number of argument supplied to the program.
 * @argv: An array of pointer to the argument.
 *
 * Return: 0 on success.
 *
 * Description:  the argument count if  is incorrect - exit code 97.
